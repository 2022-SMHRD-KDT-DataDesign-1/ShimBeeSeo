	...
	public String ScoreList(HttpSession session, String item, String photo, String result_direction, String mood, @RequestParam List<String> size, String position, String sight, @RequestParam List<String> roof, String wall,
		...
		for(int i = 0; i < items_yu.length; i++) {
			for(int j = 0; j < objects.size(); j++) {
				...
				if(items_yu[i].equals(objects.get(j).getObject_name()) && objects.get(j).getObject_exist() == 1) {
					result_o_text += "<strong class='title'>" + o + "</strong><div style='display : none;'>" + objects.get(j).getObject_content() + "</div>";
				} 
		...
		for(int i = 0; i < h_cases.size(); i++) {
			if(h_cases.get(i).getCase_h_emotion().equals("공격성") && (aggressive >= h_cases.get(i).getCase_h_s() && aggressive <= h_cases.get(i).getCase_h_e())) {
				result_c_text +=  "<p><strong class='title'>공격성</strong></p><div style='display : none;'>" + h_cases.get(i).getCase_h_content() + "</div>";
			} else if(h_cases.get(i).getCase_h_emotion().equals("사회불안") && (anxiety >= h_cases.get(i).getCase_h_s() && anxiety <= h_cases.get(i).getCase_h_e())) {
				result_c_text +=  "<p><strong class='title'>사회불안</strong></p><div style='display : none;'>" + h_cases.get(i).getCase_h_content() + "</div>";
				...
				result_c_text +=  "<p><div><strong class='title'>우울</strong></p><div style='display : none;'>" + h_cases.get(i).getCase_h_content() + "</div>";
			} else if(h_cases.get(i).getCase_h_emotion().equals("대인회피") && (avpd >= h_cases.get(i).getCase_h_s() && avpd <= h_cases.get(i).getCase_h_e())) {
				result_c_text +=  "<p><strong class='title'>대인회피</strong></p><div style='display : none;'>" + h_cases.get(i).getCase_h_content() + "</div>";
			} else if(h_cases.get(i).getCase_h_emotion().equals("자존감") && (esteem >= h_cases.get(i).getCase_h_s() && esteem <= h_cases.get(i).getCase_h_e())) {
				result_c_text +=  "<p><strong class='title'>자존감</strong></p><div style='display : none;'>" + h_cases.get(i).getCase_h_content() + "</div>";
				...
				result_c_text2 +=  "<p><strong class='title'>정서불안</strong></p><div style='display : none;'>" + h_cases.get(i).getCase_h_content() + "</div>";
				...
				result_c_text2 +=  "<p><strong class='title'>애정결핍</strong></p><div style='display : none;'>" + h_cases.get(i).getCase_h_content() + "</div>";
				...
				result_c_text2 +=  "<p><strong class='title'>열등감</strong></p><div style='display : none;'>" + h_cases.get(i).getCase_h_content() + "</div>";
				...
				result_c_text2 +=  "<p><strong class='title'>퇴행</strong></p><div style='display : none;'>" + h_cases.get(i).getCase_h_content() + "</div>";
			}
		}
