...
<body>
 ...
 <div class="container-xxl bg-white p-0">
	...
	<input type="hidden" id="result_aggressive" value="${result.result_aggressive}">
	<input type="hidden" id="result_social_anxiety" value="${result.result_social_anxiety}">
	<input type="hidden" id="result_depressed" value="${result.result_depressed}">
	<input type="hidden" id="result_avpd" value="${result.result_avpd}">
	<input type="hidden" id="result_self_esteem" value="${result.result_self_esteem}">
	<input type="hidden" id="result_emotional_instability" value="${result.result_emotional_instability}">
	<input type="hidden" id="result_deprivation" value="${result.result_deprivation}">
	<input type="hidden" id="result_inferiority" value="${result.result_inferiority}">
	<input type="hidden" id="result_regression" value="${result.result_regression}">
</div>
